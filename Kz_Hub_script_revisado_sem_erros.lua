-- [Proteções automáticas aplicadas para evitar erros de execução]
function safeHumanoid(npc)
    return npc:FindFirstChild("Humanoid") and npc:FindFirstChild("HumanoidRootPart")
end

function safeCombatFramework()
    return game.Players.LocalPlayer:FindFirstChild("PlayerScripts") and game.Players.LocalPlayer.PlayerScripts:FindFirstChild("CombatFramework")
end

function safeProjectileCheck(obj)
    return obj and obj:FindFirstChild("cannon")
end

function getHumanoidSafe(model)
...
function CheckQuest() 
    ...
    if World1 then
        ...
        elseif MyLevel == 375 or MyLevel <= 399 then
            ...
            if _G.AutoFarm and (CFrameQuest.Position - game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).Magnitude > 10000 then
...
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                     wait()
                    pcall(function()
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                         wait()
        ...
        if not isnil(v.Character) then
            if ESPPlayer then
                if not isnil(v.Character.Head) and not v.Character.Head:FindFirstChild('NameEsp'..Number) then
                    ...
                    v.Character.Head['NameEsp'..Number].TextLabel.Text = (v.Name ..' | '.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Character.Head.Position).Magnitude/3) ..' Distance\nHealth : ' .. round(v.Character:FindFirstChild("Humanoid").Health*100/v.Character:FindFirstChild("Humanoid").MaxHealth) .. '%')
                end
            else
...
--             for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                if v:FindFirstChild('HumanoidRootPart') then
                    ...
                    local Dis = math.floor((game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position - v:FindFirstChild("Humanoid")RootPart.Position).Magnitude)
...
function InfAb()
    if InfAbility then
        if not game:GetService("Players").LocalPlayer.getHumanoidSafe(Character)RootPart:FindFirstChild("Agility") then
            ...
            inf.Parent = game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart
        end
    else
        if game:GetService("Players").LocalPlayer.getHumanoidSafe(Character)RootPart:FindFirstChild("Agility") then
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--             game:GetService("Players").LocalPlayer.getHumanoidSafe(Character)RootPart:FindFirstChild("Agility"):Destroy()
        end
    end
end
...
function fly()
    ...
    local torso = game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart
    local speedSET=25
...
function GetDistance(target)
    return math.floor((target.Position - game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).Magnitude)
end

function BTP(P)
	repeat wait(1)
		game.Players.LocalPlayer.Character:FindFirstChild("Humanoid"):ChangeState(15)
		game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.CFrame = P
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
-- 		task.wait()
		game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.CFrame = P
	until (P.Position-game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).Magnitude <= 1500
end
...
function TelePPlayer(P)
    ...
    function TP(Pos)
    Distance = (Pos.Position - game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).Magnitude
    if Distance < 25 then
        Speed = 10000
    ...
    game:GetService("TweenService"):Create(
        game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart,
...
--     ):Play()
    ...
    function TP1(Pos)
        ...
        game:GetService("TweenService"):Create(
            game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart,
            TweenInfo.new(Distance/Speed, Enum.EasingStyle.Linear),
            {CFrame = Pos}
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--         ):Play()
...
function TPP(CFgo)
	...
	local tween_s = game:service"TweenService"
	local info = TweenInfo.new((game:GetService("Players")["LocalPlayer"].Character:FindFirstChild("Humanoid")RootPart.Position - CFgo.Position).Magnitude/325, Enum.EasingStyle.Linear)
...
task.spawn(function()
    pcall(function()
        if game:GetService("Players").LocalPlayer:DistanceFromCharacter(p.Position) <= 250 then 
            game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.CFrame = p
        elseif not game.Players.LocalPlayer.Character:FindFirstChild("Root")then 
            ...
            K.Transparency = 1
            K.CanCollide = false
            K.CFrame = game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.CFrame * CFrame.new(0,20,0)
        end
        local U = (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position-p.Position).Magnitude
...
--         q:Play()
    ...
    game.Players.LocalPlayer.Character.Root.CFrame = game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.CFrame
        if S and game.Players.LocalPlayer.Character:FindFirstChild("Root") then 
            pcall(function()
                if (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position-p.Position).Magnitude >= 20 then 
                    spawn(function()
                        pcall(function()
                            if (game.Players.LocalPlayer.Character.Root.Position-game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).Magnitude > 150 then 
                                game.Players.LocalPlayer.Character.Root.CFrame = game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.CFrame
                            else 
                                game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.CFrame=game.Players.LocalPlayer.Character.Root.CFrame
                            end
                        end)
                    end)
                elseif (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position-p.Position).Magnitude >= 10 and(game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position-p.Position).Magnitude < 20 then 
                    game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.CFrame = p
                elseif (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position-p.Position).Magnitude < 10 then 
                    game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.CFrame = p
                end
            end)
        end
...
--                 for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
                    if not string.find(v.Name,"Boss") and (v:FindFirstChild("Humanoid")RootPart.Position - game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).Magnitude <= _G.BringMode then
                        if InMyNetWork(v:FindFirstChild("Humanoid")RootPart) then
                            v:FindFirstChild("Humanoid")RootPart.CFrame = PosMon
                            v:FindFirstChild("Humanoid").JumpPower = 0
                            v:FindFirstChild("Humanoid").WalkSpeed = 0
                            v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(60,60,60)
                            v:FindFirstChild("Humanoid")RootPart.Transparency = 1
                            v:FindFirstChild("Humanoid")RootPart.CanCollide = false
                            v.Head.CanCollide = false
                            if getHumanoidSafe(v):FindFirstChild("Animator") then
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
...
--     if _G.AutoVampire or AutoFarmChest or _G.AutoAdvanceDungeon or _G.AutoDoughtBoss or _G.Auto_DungeonMobAura or _G.AutoFarmChest or _G.AutoFactory or _G.AutoFarmBossHallow or _G.AutoFarmSwanGlasses or _G.AutoLongSword or _G.AutoBlackSpikeycoat or _G.AutoElectricClaw or _G.AutoFarmGunMastery or _G.AutoHolyTorch or _G.AutoLawRaid or _G.AutoFarmBoss or _G.AutoTwinHooks or _G.AutoOpenSwanDoor or _G.AutoDragon_Trident or _G.AutoSaber or _G.NOCLIP or _G.AutoFarmFruitMastery or _G.AutoFarmGunMastery or _G.TeleportIsland or _G.Auto_EvoRace or _G.AutoFarmAllMsBypassType or _G.AutoObservationv2 or _G.AutoMusketeerHat or _G.AutoEctoplasm or _G.AutoRengoku or _G.Auto_Rainbow_Haki or _G.AutoObservation or _G.AutoDarkDagger or _G.Safe_Mode or _G.MasteryFruit or _G.AutoBudySword or _G.AutoOderSword or _G.AutoBounty or _G.AutoAllBoss or _G.Auto_Bounty or _G.AutoSharkman or _G.Auto_Mastery_Fruit or _G.Auto_Mastery_Gun or _G.Auto_Dungeon or _G.Auto_Cavender or _G.Auto_Pole or _G.Auto_Kill_Ply or _G.Auto_Factory or _G.AutoSecondSea or _G.TeleportPly or _G.AutoBartilo or _G.Auto_DarkBoss or _G.GrabChest or _G.AutoFarmBounty or _G.Holy_Torch or _G.AutoFarm or _G.Clip or _G.AutoElitehunter or _G.AutoThirdSea or _G.Auto_Bone or _G.Autoheart or _G.Autodoughking or _G.AutoFarmMaterial or _G.AutoNevaSoulGuitar or _G.Auto_Dragon_Trident or _G.Autotushita or _G.d or _G.Autowaden or _G.Autogay or _G.Autopole or _G.Autosaw or _G.AutoObservationHakiV2 or _G.AutoFarmNearest or AutoFarmChest or _G.AutoCarvender or _G.AutoTwinHook or AutoMobAura or _G.Tweenfruit or _G.AutoKai or _G.TeleportNPC or _G.Leather or _G.Auto_Wing or _G.Umm or _G.Makori_gay or Radioactive or Fish or Gunpowder or Dragon_Scale or Cocoafarm or Scrap or MiniHee or _G.AutoFarmSeabaest or Auto_Cursed_Dual_Katana or _G.AutoFarmMob or _G.AutoMysticIsland or _G.AutoFarmDungeon or _G.AutoRaidPirate or _G.AutoQuestRace or _G.TweenMGear or getgenv().AutoFarm or _G.AutoPlayerHunter or _G.AutoFactory or Grab_Chest or _G.Namfon or _G.AutoSwordMastery or _G.AutoSeaBest or _G.AutoKillTial or _G.Auto_Saber or _G.Position_Spawn or _G.Farmfast or _G.AutoRace or _G.RaidPirate then
        ...
        elseif game:GetService("Workspace"):FindFirstChild("LOL") then
            game.Workspace["LOL"].CFrame = game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.CFrame * CFrame.new(0, -3.6, 0)
        end
    else
...
--         while wait() do
            if _G.AutoVampire or AutoFarmChest or _G.AutoAdvanceDungeon or _G.AutoDoughtBoss or _G.Auto_DungeonMobAura or _G.AutoFarmChest or _G.AutoFactory or _G.AutoFarmBossHallow or _G.AutoFarmSwanGlasses or _G.AutoLongSword or _G.AutoBlackSpikeycoat or _G.AutoElectricClaw or _G.AutoFarmGunMastery or _G.AutoHolyTorch or _G.AutoLawRaid or _G.AutoFarmBoss or _G.AutoTwinHooks or _G.AutoOpenSwanDoor or _G.AutoDragon_Trident or _G.AutoSaber or _G.AutoFarmFruitMastery or _G.AutoFarmGunMastery or _G.TeleportIsland or _G.Auto_EvoRace or _G.AutoFarmAllMsBypassType or _G.AutoObservationv2 or _G.AutoMusketeerHat or _G.AutoEctoplasm or _G.AutoRengoku or _G.Auto_Rainbow_Haki or _G.AutoObservation or _G.AutoDarkDagger or _G.Safe_Mode or _G.MasteryFruit or _G.AutoBudySword or _G.AutoOderSword or _G.AutoBounty or _G.AutoAllBoss or _G.Auto_Bounty or _G.AutoSharkman or _G.Auto_Mastery_Fruit or _G.Auto_Mastery_Gun or _G.Auto_Dungeon or _G.Auto_Cavender or _G.Auto_Pole or _G.Auto_Kill_Ply or _G.Auto_Factory or _G.AutoSecondSea or _G.TeleportPly or _G.AutoBartilo or _G.Auto_DarkBoss or _G.GrabChest or _G.AutoFarmBounty or _G.Holy_Torch or _G.AutoFarm or _G.Clip or FarmBoss or _G.AutoElitehunter or _G.AutoThirdSea or _G.Auto_Bone or _G.Autoheart or _G.Autodoughking or _G.AutoFarmMaterial or _G.AutoNevaSoulGuitar or _G.Auto_Dragon_Trident or _G.Autotushita or _G.d or _G.Autowaden or _G.Autogay or _G.Autopole or _G.Autosaw or _G.AutoObservationHakiV2 or _G.AutoFarmNearest or AutoFarmChest or _G.AutoCarvender or _G.AutoTwinHook or AutoMobAura or _G.Tweenfruit or _G.TeleportNPC or _G.Leather or _G.Auto_Wing or _G.Umm or _G.Makori_gay or Radioactive or Fish or Gunpowder or Dragon_Scale or Cocoafarm or Scrap or MiniHee or _G.AutoFarmSeabaest or Auto_Cursed_Dual_Katana or _G.AutoFarmMob or _G.AutoMysticIsland or _G.AutoFarmDungeon or _G.AutoRaidPirate or _G.AutoQuestRace or _G.TweenMGear or getgenv().AutoFarm or _G.AutoPlayerHunter or _G.AutoFactory or Grab_Chest or _G.Namfon or _G.AutoSwordMastery or _G.Auto_Seabest or _G.AutoSeaBest or _G.AutoKillTial or _G.Auto_Saber or _G.Position_Spawn or _G.Farmfast or _G.AutoRace or _G.RaidPirate == true then
                if not game:GetService("Players").LocalPlayer.getHumanoidSafe(Character)RootPart:FindFirstChild("BodyClip") then
                    local Noclip = Instance.new("BodyVelocity")
                    Noclip.Name = "BodyClip"
                    Noclip.Parent = game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart
...
function InstancePos(pos)
    game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.CFrame = pos
end
...
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--         wait()
        topos(game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.CFrame)
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--         wait()
        if game:GetService("Players").LocalPlayer.getHumanoidSafe(Character)RootPart:FindFirstChild("BodyClip") then
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--             game:GetService("Players").LocalPlayer.getHumanoidSafe(Character)RootPart:FindFirstChild("BodyClip"):Destroy()
        end
        _G.StopTween = false
        _G.Clip = false
    end
...
-- 		for r, v in pairs(game:GetService("Workspace").NPCs:GetChildren()) do
		...
		topos(TempleMysteriousNPC2:FindFirstChild("Humanoid")RootPart.CFrame)
		wait(0.5)
		if
			(TempleMysteriousNPC2:FindFirstChild("Humanoid")RootPart.Position - game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).Magnitude <
				15
		 then
			game.ReplicatedStorage.Remotes.CommF_:InvokeServer("RaceV4Progress", "TeleportBack")
		end
		if
			(TempleMysteriousNPC1:FindFirstChild("Humanoid")RootPart.Position - game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).Magnitude <
				15
		 then
	...
	function CheckAndTweenTemple()
		if (TempleOfTimeCFrame.Position - game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).Magnitude > 1200 then
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
-- 			TweenTemple()
		end
		if (TempleOfTimeCFrame.Position - game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).Magnitude > 1200 then
...
-- 			game:GetService("Lighting"):GetMoonDirection() + workspace.CurrentCamera.CFrame.Position
    ...
    local STOP = require(Client.PlayerScripts.FindFirstChild("CombatFramework").Particle)
    local STOPRL = require(game:GetService("ReplicatedStorage").FindFirstChild("CombatFramework").RigLib)
    spawn(function()
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--         while task.wait() do
            pcall(function()
...
function GetBladeHit()
    local FindFirstChild("CombatFramework")Lib = debug.getupvalues(require(game:GetService("Players").LocalPlayer.PlayerScripts.FindFirstChild("CombatFramework")))
    local CmrFwLib = FindFirstChild("CombatFramework")Lib[2]
...
function AttackHit()
    ...
    for i = 1, 1 do
        local bladehit = require(game.ReplicatedStorage.CombatFramework.RigLib).getBladeHits(plr.Character,{plr.Character:FindFirstChild("Humanoid")RootPart},60)
        local cac = {}
        local hash = {}
        for k, v in pairs(bladehit) do
            if v.Parent:FindFirstChild("HumanoidRootPart") and not hash[v.Parent] then
                table.insert(cac, v.Parent:FindFirstChild("Humanoid")RootPart)
                hash[v.Parent] = true
            end
        end
        bladehit = cac
...
FindFirstChild("CombatFramework")R = require(game:GetService("Players").LocalPlayer.PlayerScripts.FindFirstChild("CombatFramework"))
y = debug.getupvalues(FindFirstChild("CombatFramework")R)[2]
spawn(function()
    game:GetService("RunService").RenderStepped:Connect(function()
        if _G.FastAttack then
...
--             for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
                if v:IsA('Tool') and not (v.Name == "Summon Sea Beast" or v.Name == "Water Body" or v.Name == "Awakening") then
                    ...
                    game.Players.LocalPlayer.Character:FindFirstChild("Humanoid"):EquipTool(ToolHumanoid) 
                    wait(1)
                end
            end
        end)
...
IQ:AddToggle({
    ...
    Callback = function(Value)
        ...
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
        wait(1)
        game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.CFrame = CFrame.new(-5411.22021, 778.609863, -2682.27759, 0.927179396, 0, 0.374617696, 0, 1, 0, -0.374617696, 0, 0.927179396)
        wait(0)
        ...
        function two(gotoCFrame) --- Tween
              pcall(function()
                  ...
                  game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Anchored = false
              end)
              if (game:GetService("Players")["LocalPlayer"].Character:FindFirstChild("Humanoid")RootPart.Position - gotoCFrame.Position).Magnitude <= 200 then
                  pcall(function() 
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                       tweenz:Cancel()
                  end)
                  game:GetService("Players")["LocalPlayer"].Character:FindFirstChild("Humanoid")RootPart.CFrame = gotoCFrame
              else
                  local tween_s = game:service"TweenService"
                  local info = TweenInfo.new((game:GetService("Players")["LocalPlayer"].Character:FindFirstChild("Humanoid")RootPart.Position - gotoCFrame.Position).Magnitude/325, Enum.EasingStyle.Linear)
...
--         for _,v in next, workspace.Boats.PirateBrigade:GetDescendants() do
            ...
            game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.CFrame = v.CFrame
             if game:GetService("Workspace").Map:FindFirstChild("MysticIsland") then
...
--         for i,v in pairs(game:GetService("Workspace").SeaBeasts:GetChildren()) do
            if v:FindFirstChild("HumanoidRootPart") then
                topos(v:FindFirstChild("Humanoid")RootPart.CFrame*CFrame.new(0,100,0))
            end
        end
    end    
})
    ...
    Callback = function(Value)
        ...
        pcall(function()
            if _G.TeleportPly then
                repeat topos(game:GetService("Players")[_G.SelectPly].Character:FindFirstChild("Humanoid")RootPart.CFrame) wait() until _G.TeleportPly == false
            end
...
--                 for i,v in pairs(game.Workspace:GetChildren()) do
                    if v:IsA("Tool") then
                        v.Handle.CFrame = game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.CFrame
                    end
                end	
            end)
        end
...
R:AddButton({
    ...
    Callback = function()
        Game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
      end    
})
                            ...
                            if typeof(v) == "function" and getfenv(v).script == game:GetService("Players").LocalPlayer.Character.Soru then
                                for i2,v2 in next, getupvalues(v) do
                                    if typeof(v2) == "table" then
                                        repeat wait(0.1)
                                            v2.LastUse = 0
                                        until not getgenv().InfSoru or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid").Health <= 0
                                    end
                                end
                            end
                        end
                        ...
                        if typeof(v) == "function" and getfenv(v).script == game:GetService("Players").LocalPlayer.Character.Geppo then
                            for i2,v2 in next, getupvalues(v) do
                                if tostring(i2) == "9" then
                                    repeat wait(.1)
                                        setupvalue(v,i2,0)
                                    until not getgenv().InfGeppo or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid").Health <= 0 
                                end
                            end
                        end
                    end
...
--                     CheckQuest()
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position - CFrameQuest.Position).Magnitude > 1500 then
                    BTP(CFrameQuest)
                    elseif (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position - CFrameQuest.Position).Magnitude < 1500 then
                    topos(CFrameQuest)
                    end
                else
                    topos(CFrameQuest)
                end
                if (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position - CFrameQuest.Position).Magnitude <= 20 then
...
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                         for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and getHumanoidSafe(v).Health > 0 then
                                if v.Name == Mon then
...
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                             AutoHaki()                                            
                                            PosMon = v:FindFirstChild("Humanoid")RootPart.CFrame
                                            TP1(v:FindFirstChild("Humanoid")RootPart.CFrame * Pos)
                                            v:FindFirstChild("Humanoid")RootPart.CanCollide = false
                                            v:FindFirstChild("Humanoid").WalkSpeed = 0
                                            v.Head.CanCollide = false
                                            v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(100,100,100)
                                            StartMagnet = true
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                             game:GetService'VirtualUser':CaptureController()
                                            game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
                                        until not _G.AutoFarm or v:FindFirstChild("Humanoid").Health <= 0 or not v.Parent or game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false
                                    else
                                        StartMagnet = false
                                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
                                    end
...
--                     repeat wait()
                        TP1(CFrameQuest)
                    until (CFrameQuest.Position - game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).Magnitude <= 3 or not _G.AutoFarmFruitMastery
                    if (CFrameQuest.Position - game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).Magnitude <= 5 then
                        wait(0.1)
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StartQuest",NameQuest,LevelQuest)
                        wait(0.1)
                    end
...
--                         for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and getHumanoidSafe(v).Health > 0 then
                                if v.Name == Mon then
                                    if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
                                        HealthMs = v:FindFirstChild("Humanoid").MaxHealth * _G.Kill_At/100
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                         repeat task.wait()
                                            if v:FindFirstChild("Humanoid").Health <= HealthMs then
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                                 AutoHaki()
                                                EquipWeapon(game:GetService("Players").LocalPlayer.Data.DevilFruit.Value)
                                                TP1(v:FindFirstChild("Humanoid")RootPart.CFrame * CFrame.new(0,20,0))
                                                v:FindFirstChild("Humanoid")RootPart.CanCollide = false
                                                PosMonMasteryFruit = v:FindFirstChild("Humanoid")RootPart.CFrame
                                                v:FindFirstChild("Humanoid").WalkSpeed = 0
                                                v.Head.CanCollide = false
                                                UseSkill = true
                                            else           
...
--                                             game:GetService'VirtualUser':CaptureController()
                                            game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
                                        until not _G.AutoFarmFruitMastery or v:FindFirstChild("Humanoid").Health <= 0 or not v.Parent or game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false
                                    else
                                        UseSkill = false
                                        StartMasteryFruitMagnet = false
                                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
                        ...
                        if Mob then
                            TP1(Mob:FindFirstChild("Humanoid")RootPart.CFrame * CFrame.new(0,0,10))
                        else
                            if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.CFrame.Y <= 1 then
                                game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid").Jump = true
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                 task.wait()
                                game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid").Jump = false
                            end
                        end
                    end
                end
...
--                 for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    ...
                    elseif game:GetService("Players").LocalPlayer.Character:FindFirstChild("Human-Human: Buddha") then
                        if _G.SkillZ and game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Size == Vector3.new(2, 2.0199999809265, 1) then
                            local args = {
                                [1] = PosMonMasteryFruit.Position
                            }
                            game:GetService("Players").LocalPlayer.Character[game:GetService("Players").LocalPlayer.Character:FindFirstChildOfClass("Tool").Name].RemoteEvent:FireServer(unpack(args))                         
...
--                     CheckQuest()
                    TP1(CFrameQuest)
                    if (CFrameQuest.Position - game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).Magnitude <= 10 then
                        wait(0.1)
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StartQuest", NameQuest, LevelQuest)
                    end
                elseif game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
...
--                                     repeat task.wait()
                                        if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
                                            HealthMin = v:FindFirstChild("Humanoid").MaxHealth * _G.Kill_At/100
                                            if v:FindFirstChild("Humanoid").Health <= HealthMin then                                                
                                                EquipWeapon(SelectWeaponGun)
                                                TP1(v:FindFirstChild("Humanoid")RootPart.CFrame * CFrame.new(0,10,0))
                                                v:FindFirstChild("Humanoid").WalkSpeed = 0
                                                v:FindFirstChild("Humanoid")RootPart.CanCollide = false
                                                v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(2,2,1)
                                                v.Head.CanCollide = false                                                
                                                local args = {
                                                    [1] = v:FindFirstChild("Humanoid")RootPart.Position,
                                                    [2] = v:FindFirstChild("Humanoid")RootPart
                                                }
...
--                                                 AutoHaki()
                                                ...
                                                v:FindFirstChild("Humanoid")RootPart.CanCollide = false
                                                v.Head.CanCollide = false               
                                                v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(50,50,50)
                                                TP1(v:FindFirstChild("Humanoid")RootPart.CFrame * Pos)
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                                 game:GetService'VirtualUser':CaptureController()
                                                game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
                                            ...
                                            PosMonMasteryGun = v:FindFirstChild("Humanoid")RootPart.CFrame
                                        else
                                            StartMasteryGunMagnet = false
                                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
                                        end
                                    until v:FindFirstChild("Humanoid").Health <= 0 or _G.AutoFarmGunMastery == false or game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false
                                    StartMasteryGunMagnet = false
                                end
                            end
                        end)
            ...
            pcall(function()
                if game.Players.LocalPlayer.Data.Level.Value >= 700 and World1 then
                    ...
                    if game.Workspace.Map.Ice.Door.CanCollide == true and game.Workspace.Map.Ice.Door.Transparency == 0 then
                        repeat wait() topos(CFrame.new(4851.8720703125, 5.6514348983765, 718.47094726563)) until (CFrame.new(4851.8720703125, 5.6514348983765, 718.47094726563).Position - game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).Magnitude <= 3 or not _G.AutoSecondSea
                        wait(1)
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("DressrosaQuestProgress","Detective")
                        EquipWeapon("Key")
                        local pos2 = CFrame.new(1347.7124, 37.3751602, -1325.6488)
                        repeat wait() topos(pos2) until (pos2.Position - game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).Magnitude <= 3 or not _G.AutoSecondSea
                        wait(3)
                    elseif game.Workspace.Map.Ice.Door.CanCollide == false and game.Workspace.Map.Ice.Door.Transparency == 1 then
                        if game:GetService("Workspace").Enemies:FindFirstChild("Ice Admiral") then
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                             for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                if v.Name == "Ice Admiral" and v:FindFirstChild("Humanoid").Health > 0 then
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                     repeat wait()
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                         AutoHaki()
                                        ...
                                        v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(60,60,60)
                                        v:FindFirstChild("Humanoid")RootPart.Transparency = 1
                                        topos(v:FindFirstChild("Humanoid")RootPart.CFrame * CFrame.new(2,20,2))
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                         game:GetService("VirtualUser"):CaptureController()
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280, 870),workspace.CurrentCamera.CFrame)
                                    until v:FindFirstChild("Humanoid").Health <= 0 or not v.Parent or not _G.AutoSecondSea
                                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
                                end
                            end
                        else
...
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                 for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    if _G.AutoFarm and StartMagnet and v.Name == Mon and (Mon == "Factory Staff" or Mon == "Monkey" or Mon == "Dragon Crew Warrior" or Mon == "Dragon Crew Archer") and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and getHumanoidSafe(v).Health > 0 and (getHumanoidSafe(v)RootPart.Position - game:GetService("Players").LocalPlayer.getHumanoidSafe(Character)RootPart.Position).Magnitude <= 220 then
                        v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(50,50,50)
                        v:FindFirstChild("Humanoid")RootPart.CFrame = PosMon
                        v:FindFirstChild("Humanoid"):ChangeState(14)
                        v:FindFirstChild("Humanoid")RootPart.CanCollide = false
...
--                             v:FindFirstChild("Humanoid").Animator:Destroy()
                    ...
                    elseif _G.AutoFarm and StartMagnet and v.Name == Mon and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and getHumanoidSafe(v).Health > 0 and (getHumanoidSafe(v)RootPart.Position - game:GetService("Players").LocalPlayer.getHumanoidSafe(Character)RootPart.Position).Magnitude <= _G.BringMode then
                        v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(50,50,50)
                        v:FindFirstChild("Humanoid")RootPart.CFrame = PosMon
                        v:FindFirstChild("Humanoid"):ChangeState(14)
                        v:FindFirstChild("Humanoid")RootPart.CanCollide = false
...
--                 for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    if _G.AutoFarm and StartMagnet and v.Name == Mon and (Mon == "Factory Staff" or Mon == "Monkey" or Mon == "Dragon Crew Warrior" or Mon == "Dragon Crew Archer") and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and getHumanoidSafe(v).Health > 0 and (getHumanoidSafe(v)RootPart.Position - game:GetService("Players").LocalPlayer.getHumanoidSafe(Character)RootPart.Position).Magnitude <= 250 then
                        v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(150,150,150)
                        v:FindFirstChild("Humanoid")RootPart.CFrame = PosMon
                        v:FindFirstChild("Humanoid"):ChangeState(14)
                        v:FindFirstChild("Humanoid")RootPart.CanCollide = false
                        v.Head.CanCollide = false
...
--                             v:FindFirstChild("Humanoid").Animator:Destroy()
                    ...
                    if _G.Farmfast and StardMag then
                        if (v.Name == "Shanda") and (getHumanoidSafe(v)RootPart.Position - FastMon.Position).Magnitude <= 250 and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and getHumanoidSafe(v).Health > 0 then
                            v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(50,50,50)
                        v:FindFirstChild("Humanoid")RootPart.CFrame = FastMon
                        v:FindFirstChild("Humanoid"):ChangeState(14)
                        v:FindFirstChild("Humanoid")RootPart.CanCollide = false
                        v.Head.CanCollide = false
                        if getHumanoidSafe(v):FindFirstChild("Animator") then
...
--                             v:FindFirstChild("Humanoid").Animator:Destroy()
                    ...
                    if _G.AutoVampire and YouSkidder then
                        if (v.Name == "Vampire") and (getHumanoidSafe(v)RootPart.Position - PosVui.Position).Magnitude <= 500 and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and getHumanoidSafe(v).Health > 0 then
                            v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(50,50,50)
                        v:FindFirstChild("Humanoid")RootPart.CFrame = PosVui
                        v:FindFirstChild("Humanoid"):ChangeState(14)
                        v:FindFirstChild("Humanoid")RootPart.CanCollide = false
                        v.Head.CanCollide = false
                        if getHumanoidSafe(v):FindFirstChild("Animator") then
...
--                             v:FindFirstChild("Humanoid").Animator:Destroy()
                    ...
                    if _G.AutoEctoplasm and StartEctoplasmMagnet then
                        if string.find(v.Name, "Ship") and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and getHumanoidSafe(v).Health > 0 and (getHumanoidSafe(v)RootPart.Position - EctoplasmMon.Position).Magnitude <= _G.BringMode then
                            v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(50,50,50)
                            v:FindFirstChild("Humanoid")RootPart.CFrame = EctoplasmMon
                            v:FindFirstChild("Humanoid"):ChangeState(14)
                            v:FindFirstChild("Humanoid")RootPart.CanCollide = false
                            v.Head.CanCollide = false
                            if getHumanoidSafe(v):FindFirstChild("Animator") then
...
--                                 v:FindFirstChild("Humanoid").Animator:Destroy()
                    ...
                    if _G.AutoRengoku and StartRengokuMagnet then
                        if (v.Name == "Snow Lurker" or v.Name == "Arctic Warrior") and (getHumanoidSafe(v)RootPart.Position - RengokuMon.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and getHumanoidSafe(v).Health > 0 then
                            v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(1500,1500,1500)
                            v:FindFirstChild("Humanoid"):ChangeState(14)
                            v:FindFirstChild("Humanoid")RootPart.CanCollide = false
                            v.Head.CanCollide = false
                            v:FindFirstChild("Humanoid")RootPart.CFrame = RengokuMon
                            if getHumanoidSafe(v):FindFirstChild("Animator") then
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                 v:FindFirstChild("Humanoid").Animator:Destroy()
                            end
                    ...
                    if _G.AutoMusketeerHat and StartMagnetMusketeerhat then
                        if v.Name == "Forest Pirate" and (getHumanoidSafe(v)RootPart.Position - MusketeerHatMon.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and getHumanoidSafe(v).Health > 0 then
                            v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(50,50,50)
                            v:FindFirstChild("Humanoid"):ChangeState(14)
                            v:FindFirstChild("Humanoid")RootPart.CanCollide = false
                            v.Head.CanCollide = false
                            v:FindFirstChild("Humanoid")RootPart.CFrame = MusketeerHatMon
                            if getHumanoidSafe(v):FindFirstChild("Animator") then
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                 v:FindFirstChild("Humanoid").Animator:Destroy()
                            end
                    ...
                    if _G.AutoObservationHakiV2 and Mangnetcitzenmon then
                        if v.Name == "Forest Pirate" and (getHumanoidSafe(v)RootPart.Position - MusketeerHatMon.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and getHumanoidSafe(v).Health > 0 then
                            ...
                            v:FindFirstChild("Humanoid")RootPart.CanCollide = false
                            v.Head.CanCollide = false
                            v:FindFirstChild("Humanoid")RootPart.CFrame = PosHee
                            if getHumanoidSafe(v):FindFirstChild("Animator") then
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                 v:FindFirstChild("Humanoid").Animator:Destroy()
                            end
                    ...
                    if _G.Auto_EvoRace and StartEvoMagnet then
                        if v.Name == "Zombie" and (getHumanoidSafe(v)RootPart.Position - PosMonEvo.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and getHumanoidSafe(v).Health > 0 then
                            v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(50,50,50)
                            v:FindFirstChild("Humanoid"):ChangeState(14)
                            v:FindFirstChild("Humanoid")RootPart.CanCollide = false
                            v.Head.CanCollide = false
                            v:FindFirstChild("Humanoid")RootPart.CFrame = PosMonEvo
                            if getHumanoidSafe(v):FindFirstChild("Animator") then
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                 v:FindFirstChild("Humanoid").Animator:Destroy()
                            end
                    ...
                    if _G.AutoBartilo and AutoBartiloBring then
                        if v.Name == "Swan Pirate" and (getHumanoidSafe(v)RootPart.Position - PosMonBarto.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and getHumanoidSafe(v).Health > 0 then
                            v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(50,50,50)
                            v:FindFirstChild("Humanoid"):ChangeState(14)
                            v:FindFirstChild("Humanoid")RootPart.CanCollide = false
                            v.Head.CanCollide = false
                            v:FindFirstChild("Humanoid")RootPart.CFrame = PosMonBarto
                            if getHumanoidSafe(v):FindFirstChild("Animator") then
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                 v:FindFirstChild("Humanoid").Animator:Destroy()
                            end
                    ...
                    if _G.AutoFarmFruitMastery and StartMasteryFruitMagnet then
                        if v.Name == "Monkey" then
                            if (getHumanoidSafe(v)RootPart.Position - PosMonMasteryFruit.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and getHumanoidSafe(v).Health > 0 then
                                v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(50,50,50)
                                v:FindFirstChild("Humanoid"):ChangeState(14)
                                v:FindFirstChild("Humanoid")RootPart.CanCollide = false
                                v.Head.CanCollide = false
                                v:FindFirstChild("Humanoid")RootPart.CFrame = PosMonMasteryFruit
                                if getHumanoidSafe(v):FindFirstChild("Animator") then
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                     v:FindFirstChild("Humanoid").Animator:Destroy()
                                end
...
--                                     v:FindFirstChild("Humanoid").Animator:Destroy()
                    ...
                    if _G.AutoFarmGunMastery and StartMasteryGunMagnet then
                        if v.Name == "Monkey" then
                            if (getHumanoidSafe(v)RootPart.Position - PosMonMasteryGun.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and getHumanoidSafe(v).Health > 0 then
                                v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(50,50,50)
                                v:FindFirstChild("Humanoid"):ChangeState(14)
                                v:FindFirstChild("Humanoid")RootPart.CanCollide = false
                                v.Head.CanCollide = false
                                v:FindFirstChild("Humanoid")RootPart.CFrame = PosMonMasteryGun
                                if getHumanoidSafe(v):FindFirstChild("Animator") then
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                     v:FindFirstChild("Humanoid").Animator:Destroy()
                                end
...
--                                     v:FindFirstChild("Humanoid").Animator:Destroy()
                    ...
                    if _G.Auto_Bone and StartMagnetBoneMon then
                        if (v.Name == "Reborn Skeleton" or v.Name == "Living Zombie" or v.Name == "Demonic Soul" or v.Name == "Posessed Mummy") and (getHumanoidSafe(v)RootPart.Position - PosMonBone.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and getHumanoidSafe(v).Health > 0 then
                            v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(50,50,50)
                            v:FindFirstChild("Humanoid"):ChangeState(14)
                            v:FindFirstChild("Humanoid")RootPart.CanCollide = false
                            v.Head.CanCollide = false
                            v:FindFirstChild("Humanoid")RootPart.CFrame = PosMonBone
                            if getHumanoidSafe(v):FindFirstChild("Animator") then
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                 v:FindFirstChild("Humanoid").Animator:Destroy()
                            end
...
--                                 v:FindFirstChild("Humanoid").Animator:Destroy()
                    ...
                    if _G.AutoFarmCandy and StartCandyMagnet then
                        if (v.Name == "Ice Cream Chef" or v.Name == "Ice Cream Commander") and (getHumanoidSafe(v)RootPart.Position - CandyMon.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and getHumanoidSafe(v).Health > 0 then
                            v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(50,50,50)
                            v:FindFirstChild("Humanoid"):ChangeState(14)
                            v:FindFirstChild("Humanoid")RootPart.CanCollide = false
                            v.Head.CanCollide = false
                            v:FindFirstChild("Humanoid")RootPart.CFrame = CandyMon
                            if getHumanoidSafe(v):FindFirstChild("Animator") then
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                 v:FindFirstChild("Humanoid").Animator:Destroy()
                            end
                    ...
                    if _G.AutoDoughtBoss and MagnetDought then
                        if (v.Name == "Cookie Crafter" or v.Name == "Cake Guard" or v.Name == "Baking Staff" or v.Name == "Head Baker") and (getHumanoidSafe(v)RootPart.Position - PosMonDoughtOpenDoor.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and getHumanoidSafe(v).Health > 0 then
                            v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(50,50,50)
                            v:FindFirstChild("Humanoid"):ChangeState(14)
                            v:FindFirstChild("Humanoid")RootPart.CanCollide = false
                            v.Head.CanCollide = false
                            v:FindFirstChild("Humanoid")RootPart.CFrame = PosMonDoughtOpenDoor
                            if getHumanoidSafe(v):FindFirstChild("Animator") then
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                 v:FindFirstChild("Humanoid").Animator:Destroy()
                            end
                        ...
                        if StardFarm and FarmMag then
                            if (v.Name == "Sweet Thief" or v.Name == "Candy Rebel" or v.Name == "Cocoa Warrior" or v.Name == "Chocolate Bar Battler") and (getHumanoidSafe(v)RootPart.Position - PosMonDoughtOpenDoor.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and getHumanoidSafe(v).Health > 0 then
                                v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(50,50,50)
                                v:FindFirstChild("Humanoid"):ChangeState(14)
                                v:FindFirstChild("Humanoid")RootPart.CanCollide = false
                                v.Head.CanCollide = false
                                v:FindFirstChild("Humanoid")RootPart.CFrame = PosGG
                                if getHumanoidSafe(v):FindFirstChild("Animator") then
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                     v:FindFirstChild("Humanoid").Animator:Destroy()
                                end
...
--                     for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        if v.Name == "Shanda" then
                            if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and getHumanoidSafe(v).Health > 0 then
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                 repeat task.wait()
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                     AutoHaki()
                                    ...
                                    v:FindFirstChild("Humanoid").WalkSpeed = 0
                                    StardMag = true
                                    FastMon = v:FindFirstChild("Humanoid")RootPart.CFrame
                                    v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(80,80,80)                             
                                    TP1(v:FindFirstChild("Humanoid")RootPart.CFrame * Pos)
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                     game:GetService("VirtualUser"):CaptureController()
                                    game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                until not _G.Farmfast or not v.Parent or v:FindFirstChild("Humanoid").Health <= 0
                                StardMag = false
...
--      repeat game:GetService("RunService").Heartbeat:wait()
     ...
     topos(v:FindFirstChild("Humanoid")RootPart.CFrame * CFrame.new(0,30,0))
     v:FindFirstChild("Humanoid")RootPart.CanCollide = false
     v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(60, 60, 60)
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--      game:GetService("VirtualUser"):CaptureController()
     game:GetService("VirtualUser"):Button1Down(Vector2.new(1280, 672), game.Workspace.CurrentCamera.CFrame)
     PosMonSelectMonster = v:FindFirstChild("Humanoid")RootPart.CFrame
     SelectMonsterMagnet = true
     until not _G.AutoFarmSelectMonster or not v.Parent or getHumanoidSafe(v).Health == 0 or not game:GetService("Workspace").Enemies:FindFirstChild(v.Name)
     end
     end
     end
     end
...
--                         repeat wait()
                          EquipWeapon(_G.SelectWeapon)
                            ...
                            topos(v:FindFirstChild("Humanoid")RootPart.CFrame * Pos)
                            v:FindFirstChild("Humanoid")RootPart.CanCollide = false
                            Fastattack = true
                            v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(60, 60, 60)
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                             game:GetService("VirtualUser"):CaptureController()
                               ...
                               PosMon = v:FindFirstChild("Humanoid")RootPart.CFrame
                        until not _G.AutoFarmNearest or not v.Parent or v:FindFirstChild("Humanoid").Health <= 0 
                        AutoFarmNearestMagnet = false
                        Fastattack = false
                    end
                end
...
--                 for i,v in pairs(game:GetService("Workspace"):GetChildren()) do 
                    if v.Name:find("Chest") then
                        if game:GetService("Workspace"):FindFirstChild(v.Name) then
                            if (v.Position - game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).Magnitude <= 5000+_G.MagnitudeAdd then
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                 repeat wait()
                                    if game:GetService("Workspace"):FindFirstChild(v.Name) then
                                        topos(v.CFrame)
...
--           for _,v in pairs(game:GetService("Workspace"):GetDescendants()) do
           ...
           firetouchinterest(game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart, v.Parent, 0) --0 is touch
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--            wait()
           firetouchinterest(game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart, v.Parent, 1) -- 1 is untouch
           end
           end
          end)
            end
...
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--              for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
             if v.Name == "Core" and v:FindFirstChild("Humanoid").Health > 0 then
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--              repeat task.wait()
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--              AutoHaki()
...
--              game:GetService("VirtualUser"):CaptureController()
             game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
             until v:FindFirstChild("Humanoid").Health <= 0 or _G.AutoFactory == false    
             end   
             end   
             else     
              topos(CFrame.new(448.46756, 199.356781, -441.389252))    
...
--                 while wait() do
                    if _G.RaidPirate then
                        pcall(function()
                            ...
                            if (CFrame.new(-5539.3115234375, 313.800537109375, -2972.372314453125).Position - game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).Magnitude <= 500 then
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                 for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                    if _G.RaidPirate and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and getHumanoidSafe(v).Health > 0 then
                                        if (v:FindFirstChild("Humanoid")RootPart.Position - game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).Magnitude < 2000 then
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                             repeat wait()
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                                 AutoHaki()
...
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                                 Click()
                                            until v:FindFirstChild("Humanoid").Health <= 0 or not v.Parent or not _G.RaidPirate
                                        end
                                    end
                                end
                            else
                                if BypassTP then
                                if (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position - CFrameBoss.Position).Magnitude > 1500 then
                                BTP(CFrameBoss)
                                elseif (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position - CFrameBoss.Position).Magnitude < 1500 then
                                topos(CFrameBoss)
                                end
                                end
                            end
...
--                             for i,v in pairs(game.Workspace.Enemies:GetDescendants()) do
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and getHumanoidSafe(v).Health > 0 then
                                    pcall(function()
                                        ...
                                        until not _G.Kill_Aura  or not v.Parent or v:FindFirstChild("Humanoid").Health <= 0
                                    end)
                                end
                            end
                        end
...
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                     for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
                                        if _G.Auto_Kill_Law and v.Name == "Order" and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and getHumanoidSafe(v).Health > 0 then
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                             repeat task.wait()
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                                 AutoHaki()
...
--                                                 game:GetService'VirtualUser':CaptureController()
                                                game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
                                            until not _G.Auto_Kill_Law or v:FindFirstChild("Humanoid").Health <= 0 or not v.Parent
                                        end
                                    end
                                end 
                            end)
...
--                                         for r, v in pairs(game:GetService("Workspace").NPCs:GetChildren()) do
                                        ...
                                        for r, v in pairs(AllNPCS) do
                                            if v.Name == "Advanced Fruit Dealer" then
                                                topos(v:FindFirstChild("Humanoid")RootPart.CFrame)
                                            end
                                        end
                                    end
                                end
...
--     while wait() do 
      local boneframe = CFrame.new(-9508.5673828125, 142.1398468017578, 5737.3603515625)
        if _G.Auto_Bone and World3 then
            pcall(function()
                  if BypassTP then
                  if (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position - boneframe.Position).Magnitude > 2000 then
                  BTP(boneframe)
                  wait(.1)
                  game.Players.localPlayer.Character:FindFirstChild("Humanoid")RootPart.CFrame = CFrame.new(-9515.3720703125, 164.00624084473, 5786.0610351562)
      game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetSpawnPoint")			
          ...
          game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetSpawnPoint")					
                  ...
                  game.Players.localPlayer.Character:FindFirstChild("Humanoid")RootPart.CFrame = CFrame.new(-9515.3720703125, 164.00624084473, 5786.0610351562)
                  wait(3)
                  elseif (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position - boneframe.Position).Magnitude < 2000 then
                  TP1(boneframe)
                  end
                  else
                    TP1(boneframe)
...
--                                     AutoHaki()
                                    ...
                                    PosMonBone = v:FindFirstChild("Humanoid")RootPart.CFrame
                                    topos(v:FindFirstChild("Humanoid")RootPart.CFrame * CFrame.new(PosX,PosY,PosZ))
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                     game:GetService("VirtualUser"):CaptureController()
                                    game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                until not _G.Auto_Bone or not v.Parent or v:FindFirstChild("Humanoid").Health <= 0
                            end
                        end
                    end
                else
...
--                                             game:GetService("VirtualUser"):CaptureController()
                                            game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                            sethiddenproperty(game:GetService("Players").LocalPlayer,"SimulationRadius",math.huge)
                                        until _G.AutoElitehunter == false or v:FindFirstChild("Humanoid").Health <= 0 or not v.Parent
                                    end
                                end
                            end
                        else
...
--                                     game:GetService("VirtualUser"):CaptureController()
                                    game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                    sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
                                until not _G.AutoDoughtBoss or not v.Parent or v:FindFirstChild("Humanoid").Health <= 0
                            end
                        end
                    end
                else
...
--                                                 AutoHaki()
                                                ...
                                                v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(80,80,80)
                                                MagnetDought = true
                                                PosMonDoughtOpenDoor = v:FindFirstChild("Humanoid")RootPart.CFrame
                                                topos(v:FindFirstChild("Humanoid")RootPart.CFrame * Pos)
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                                 game:GetService("VirtualUser"):CaptureController()
                                                game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                            until not _G.AutoDoughtBoss or not v.Parent or getHumanoidSafe(v).Health <= 0 or game:GetService("Workspace").Map.CakeLoaf.BigMirror.Other.Transparency == 0 or game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince") or game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince") or KillMob == 0
                                        end
                                    end
                                end
                            else
...
--                                     game:GetService("VirtualUser"):CaptureController()
                                    game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                    sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
                                until not  _G.Autodoughking or not v.Parent or v:FindFirstChild("Humanoid").Health <= 0
                            end
                        end
                    end
                else
...
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                 repeat task.wait()
                                    game:GetService("Players").LocalPlayer.getHumanoidSafe(Character)RootPart.CFrame = game:GetService("Workspace").Enemies:FindFirstChild("Lava Pirate").HumanoidRootPart.CFrame * CFrame.new(3,0,0)
                                until _G.AutoObservation == false or not game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel")
                            else
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                 repeat task.wait()
                                    game:GetService("Players").LocalPlayer.getHumanoidSafe(Character)RootPart.CFrame = game:GetService("Workspace").Enemies:FindFirstChild("Lava Pirate").HumanoidRootPart.CFrame * CFrame.new(0,50,0)+
                                        wait(1)
...
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                 repeat task.wait()
                                    game:GetService("Players").LocalPlayer.getHumanoidSafe(Character)RootPart.CFrame = game:GetService("Workspace").Enemies:FindFirstChild("Galley Captain").HumanoidRootPart.CFrame * CFrame.new(3,0,0)
                                until _G.AutoObservation == false or not game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel")
                            else
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                 repeat task.wait()
                                    game:GetService("Players").LocalPlayer.getHumanoidSafe(Character)RootPart.CFrame = game:GetService("Workspace").Enemies:FindFirstChild("Galley Captain").HumanoidRootPart.CFrame * CFrame.new(0,50,0)
                                    wait(1)
                                    if not game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") and _G.AutoObservation_Hop == true then
                                        game:GetService("TeleportService"):Teleport(game.PlaceId,game:GetService("Players").LocalPlayer)
                                    end
...
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                 repeat task.wait()
                                    game:GetService("Players").LocalPlayer.getHumanoidSafe(Character)RootPart.CFrame = game:GetService("Workspace").Enemies:FindFirstChild("Giant Islander").HumanoidRootPart.CFrame * CFrame.new(3,0,0)
                                until _G.AutoObservation == false or not game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel")
                            else
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                 repeat task.wait()
                                    game:GetService("Players").LocalPlayer.getHumanoidSafe(Character)RootPart.CFrame = game:GetService("Workspace").Enemies:FindFirstChild("Giant Islander").HumanoidRootPart.CFrame * CFrame.new(0,50,0)
                                    wait(1)
                                    if not game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") and _G.AutoObservation_Hop == true then
                                        game:GetService("TeleportService"):Teleport(game.PlaceId,game:GetService("Players").LocalPlayer)
                                    end
...
--                                         AutoHaki()
                                        ...
                                        v.Head.CanCollide = false 
                                        YouSkidder = true
                                        PosVui = v:FindFirstChild("Humanoid")RootPart.CFrame
                                        topos(v:FindFirstChild("Humanoid")RootPart.CFrame * Pos)
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                         game:GetService("VirtualUser"):CaptureController()
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                    until not _G.AutoVampire or not v.Parent or v:FindFirstChild("Humanoid").Health <= 0
                                    YouSkidder = false
                                end
                            end
                        end
                    ...
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position - PosVampire.Position).Magnitude > 1500 then
			        BTP(PosVampire)
				    elseif (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position - PosVampire.Position).Magnitude < 1500 then
				    topos(PosVampire)
					end
				else
				    topos(PosVampire)
            ...
            pcall(function()
                ...
                if string.find(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate"), "keys") then  
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Water Key") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Water Key") then
                        repeat wait() getgenv().ToTarget(-2604.6958, 239.432526, -10315.1982, 0.0425701365, 0, -0.999093413, 0, 1, 0, 0.999093413, 0, 0.0425701365) until (CFrame.new(-2604.6958, 239.432526, -10315.1982, 0.0425701365, 0, -0.999093413, 0, 1, 0, 0.999093413, 0, 0.0425701365).Position - game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).Magnitude <= 3 or not _G.Auto_Fully_SharkMan_Karate
                        if (CFrame.new(-2604.6958, 239.432526, -10315.1982, 0.0425701365, 0, -0.999093413, 0, 1, 0, 0.999093413, 0, 0.0425701365).Position - game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).Magnitude <= 3 then
                            wait(1.2)
                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate",true)
                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate")
                            wait(0.5)
...
--                                             AutoHaki()
                                            ...
                                            v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(80,80,80)
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                             getgenv().ToTarget(v:FindFirstChild("Humanoid")RootPart.CFrame * CFrame.new(2,20,2))
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                             game:GetService'VirtualUser':CaptureController()
                                            game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
                                            sethiddenproperty(game:GetService("Players").LocalPlayer,"SimulationRadius",math.huge)
                                        until not v.Parent or getHumanoidSafe(v).Health <= 0 or _G.AutoSharkman == false or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Water Key") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Water Key")
                                    end
                                end
                            else
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
...
--                             repeat task.wait()
                            ...
                            until not _G.AutoElectricClaw or (game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position - CFrame.new(-10371.4717, 330.764496, -10131.4199).Position).Magnitude <= 10
                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw","Start")
                            wait(2)
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                             repeat task.wait()
                                topos(CFrame.new(-12550.532226563, 336.22631835938, -7510.4233398438))
                            until not _G.AutoElectricClaw or (game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position - CFrame.new(-12550.532226563, 336.22631835938, -7510.4233398438).Position).Magnitude <= 10
                            wait(1)
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                             repeat task.wait()
                                topos(CFrame.new(-10371.4717, 330.764496, -10131.4199))
            ...
            pcall(function()
                ...
                if game:GetService("Workspace").Map.Jungle.Final.Part.Transparency == 0 then
                    if game:GetService("Workspace").Map.Jungle.QuestPlates.Door.Transparency == 0 then
                        if (CFrame.new(-1612.55884, 36.9774132, 148.719543, 0.37091279, 3.0717151e-09, -0.928667724, 3.97099491e-08, 1, 1.91679348e-08, 0.928667724, -4.39869794e-08, 0.37091279).Position - game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).Magnitude <= 100 then
                            topos(game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.CFrame)
                            wait(1)
                            game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.CFrame = game:GetService("Workspace").Map.Jungle.QuestPlates.Plate1.Button.CFrame
                            wait(1)
                            game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.CFrame = game:GetService("Workspace").Map.Jungle.QuestPlates.Plate2.Button.CFrame
                            wait(1)
                            game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.CFrame = game:GetService("Workspace").Map.Jungle.QuestPlates.Plate3.Button.CFrame
                            wait(1)
                            game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.CFrame = game:GetService("Workspace").Map.Jungle.QuestPlates.Plate4.Button.CFrame
                            wait(1)
                            game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.CFrame = game:GetService("Workspace").Map.Jungle.QuestPlates.Plate5.Button.CFrame
                            wait(1)
                        else
...
--                                                     game:GetService("VirtualUser"):CaptureController()
                                                    game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                                    sethiddenproperty(game:GetService("Players").LocalPlayer,"SimulationRadius",math.huge)
                                                    until v:FindFirstChild("Humanoid").Health <= 0 or not _G.Auto_Saber
                                                 end
                                            end
...
--                                     repeat task.wait()
                                        ...
                                        --v:FindFirstChild("Humanoid"):ChangeState(11)
                                        --v:FindFirstChild("Humanoid"):ChangeState(14)
                                        FarmPos = v:FindFirstChild("Humanoid")RootPart.CFrame
                                        MonFarm = v.Name
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                         game:GetService'VirtualUser':CaptureController()
...
--                                 game:GetService("VirtualUser"):CaptureController()
                                game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
                            until not  _G.Autopole or not v.Parent or v:FindFirstChild("Humanoid").Health <= 0
                        end
                    end
                end
            else
            if BypassTP then
            if (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position - PolePos.Position).Magnitude > 1500 then
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-7894.6176757813, 5547.1416015625, -380.29119873047))
            elseif (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position - PolePos.Position).Magnitude < 1500 then
            topos(PolePos)
            end
        else
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-7894.6176757813, 5547.1416015625, -380.29119873047))
...
--                                             AutoHaki()
                                            ...
                                            v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(50,50,50)
                                            topos(v:FindFirstChild("Humanoid")RootPart.CFrame * CFrame.new(PosX,PosY,PosZ))													
                                            PosMonBarto =  v:FindFirstChild("Humanoid")RootPart.CFrame
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                             game:GetService'VirtualUser':CaptureController()
                                            game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
                                            AutoBartiloBring = true
                                        until not v.Parent or v:FindFirstChild("Humanoid").Health <= 0 or _G.AutoBartilo == false or game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false
                                        AutoBartiloBring = false
                                    end)
                                end
                            end
                        else
                            repeat topos(CFrame.new(932.624451, 156.106079, 1180.27466, -0.973085582, 4.55137119e-08, -0.230443969, 2.67024713e-08, 1, 8.47491108e-08, 0.230443969, 7.63147128e-08, -0.973085582)) wait() until not _G.AutoBartilo or (game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position-Vector3.new(932.624451, 156.106079, 1180.27466, -0.973085582, 4.55137119e-08, -0.230443969, 2.67024713e-08, 1, 8.47491108e-08, 0.230443969, 7.63147128e-08, -0.973085582)).Magnitude <= 10
                        end
                    else
                        repeat topos(CFrame.new(-456.28952, 73.0200958, 299.895966)) wait() until not _G.AutoBartilo or (game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position-Vector3.new(-456.28952, 73.0200958, 299.895966)).Magnitude <= 10
                        wait(1.1)
...
--                         for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == Ms then
                                OldCFrameBartlio = v:FindFirstChild("Humanoid")RootPart.CFrame
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                 repeat task.wait()
                                    sethiddenproperty(game:GetService("Players").LocalPlayer, "SimulationRadius", math.huge)
                                    EquipWeapon(_G.SelectWeapon)
...
--                                     AutoHaki()
                                    ...
                                    v:FindFirstChild("Humanoid")RootPart.CanCollide = false
                                    v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(50,50,50)
                                    v:FindFirstChild("Humanoid")RootPart.CFrame = OldCFrameBartlio
                                    topos(v:FindFirstChild("Humanoid")RootPart.CFrame * CFrame.new(PosX,PosY,PosZ))
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                     game:GetService'VirtualUser':CaptureController()
                                    game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
                                    sethiddenproperty(game:GetService("Players").LocalPlayer,"SimulationRadius",math.huge)
                                until not v.Parent or v:FindFirstChild("Humanoid").Health <= 0 or _G.AutoBartilo == false
                            end
                        end
                    elseif game:GetService("ReplicatedStorage"):FindFirstChild("Jeremy") then
                        ...
                        wait(1)
                        repeat topos(CFrame.new(2099.88159, 448.931, 648.997375)) wait() until not _G.AutoBartilo or (game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position-Vector3.new(2099.88159, 448.931, 648.997375)).Magnitude <= 10
                        wait(2)
                    else
                        repeat topos(CFrame.new(2099.88159, 448.931, 648.997375)) wait() until not _G.AutoBartilo or (game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position-Vector3.new(2099.88159, 448.931, 648.997375)).Magnitude <= 10
                    end
                elseif game:GetService("Players").LocalPlayer.Data.Level.Value >= 800 and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress","Bartilo") == 2 then
                    repeat topos(CFrame.new(-1850.49329, 13.1789551, 1750.89685)) wait() until not _G.AutoBartilo or (game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position-Vector3.new(-1850.49329, 13.1789551, 1750.89685)).Magnitude <= 10
                    wait(1)
                    repeat topos(CFrame.new(-1858.87305, 19.3777466, 1712.01807)) wait() until not _G.AutoBartilo or (game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position-Vector3.new(-1858.87305, 19.3777466, 1712.01807)).Magnitude <= 10
                    wait(1)
                    repeat topos(CFrame.new(-1803.94324, 16.5789185, 1750.89685)) wait() until not _G.AutoBartilo or (game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position-Vector3.new(-1803.94324, 16.5789185, 1750.89685)).Magnitude <= 10
                    wait(1)
                    repeat topos(CFrame.new(-1858.55835, 16.8604317, 1724.79541)) wait() until not _G.AutoBartilo or (game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position-Vector3.new(-1858.55835, 16.8604317, 1724.79541)).Magnitude <= 10
                    wait(1)
                    repeat topos(CFrame.new(-1869.54224, 15.987854, 1681.00659)) wait() until not _G.AutoBartilo or (game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position-Vector3.new(-1869.54224, 15.987854, 1681.00659)).Magnitude <= 10
                    wait(1)
                    repeat topos(CFrame.new(-1800.0979, 16.4978027, 1684.52368)) wait() until not _G.AutoBartilo or (game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position-Vector3.new(-1800.0979, 16.4978027, 1684.52368)).Magnitude <= 10
                    wait(1)
                    repeat topos(CFrame.new(-1819.26343, 14.795166, 1717.90625)) wait() until not _G.AutoBartilo or (game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position-Vector3.new(-1819.26343, 14.795166, 1717.90625)).Magnitude <= 10
                    wait(1)
                    repeat topos(CFrame.new(-1813.51843, 14.8604736, 1724.79541)) wait() until not _G.AutoBartilo or (game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position-Vector3.new(-1813.51843, 14.8604736, 1724.79541)).Magnitude <= 10
                end
            end 
        end
    end)
                ...
                pcall(function()
                    if game:GetService("Players").LocalPlayer.Data.Level.Value >= 1500 and World2 then
                        ...
                        if game:GetService("ReplicatedStorage").Remotes["CommF_"]:InvokeServer("ZQuestProgress", "General") == 0 then
                            ...
                            if (CFrame.new(-1926.3221435547, 12.819851875305, 1738.3092041016).Position - game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).Magnitude <= 10 then
                                wait(1.5)
...
--                                 for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                    if v.Name == "rip_indra" then
                                        OldCFrameThird = v:FindFirstChild("Humanoid")RootPart.CFrame
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                         repeat task.wait()
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                             AutoHaki()
                                            EquipWeapon(_G.SelectWeapon)
                                            topos(v:FindFirstChild("Humanoid")RootPart.CFrame * CFrame.new(PosX,PosY,PosZ))
                                            v:FindFirstChild("Humanoid")RootPart.CFrame = OldCFrameThird
                                            v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(50,50,50)
                                            v:FindFirstChild("Humanoid")RootPart.CanCollide = false
                                            v:FindFirstChild("Humanoid").WalkSpeed = 0
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                             game:GetService'VirtualUser':CaptureController()
                                            ...
                                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
                                            sethiddenproperty(game:GetService("Players").LocalPlayer,"SimulationRadius",math.huge)
                                        until _G.AutoThirdSea == false or v:FindFirstChild("Humanoid").Health <= 0 or not v.Parent
                                    end
                                end
                            elseif not game:GetService("Workspace").Enemies:FindFirstChild("rip_indra") and (CFrame.new(-26880.93359375, 22.848554611206, 473.18951416016).Position - game:GetService("Players").LocalPlayer.getHumanoidSafe(Character)RootPart.Position).Magnitude <= 1000 then
...
--                                         game:GetService("VirtualUser"):CaptureController()
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                        sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
                                    until not _G.AutoBudySword or not v.Parent or v:FindFirstChild("Humanoid").Health <= 0
                                end
                            end
                        end
                    else
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position - BigMomPos.Position).Magnitude > 1500 then
                    BTP(BigMomPos)
                    elseif (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position - BigMomPos.Position).Magnitude < 1500 then
                    topos(BigMomPos)
                    end
                else
                    topos(BigMomPos)
            ...
            pcall(function()
                if _G.AutoNevaSoulGuitar then
                    if GetWeaponInventory("Soul Guitar") == false then
                        if (CFrame.new(-9681.458984375, 6.139880657196045, 6341.3720703125).Position - game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).Magnitude <= 5000 then
                            if game:GetService("Workspace").NPCs:FindFirstChild("Skeleton Machine") then
                                ...
                                if game:GetService("Workspace").Map["Haunted Castle"].Candle1.Transparency == 0 then
                                    if game:GetService("Workspace").Map["Haunted Castle"].Placard1.Left.Part.Transparency == 0 then
                                        Quest2 = true
                                        repeat wait() topos(CFrame.new(-8762.69140625, 176.84783935546875, 6171.3076171875)) until (CFrame.new(-8762.69140625, 176.84783935546875, 6171.3076171875).Position - game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).Magnitude <= 3 or not _G.AutoNevaSoulGuitar
                                        wait(1)
                                    ...
                                    elseif game:GetService("Workspace").Map["Haunted Castle"].Tablet.Segment1:FindFirstChild("ClickDetector") then
                                        if game:GetService("Workspace").Map["Haunted Castle"]["Lab Puzzle"].ColorFloor.Model.Part1:FindFirstChild("ClickDetector") then
                                            Quest4 = true
                                            repeat wait() topos(CFrame.new(-9553.5986328125, 65.62338256835938, 6041.58837890625)) until (CFrame.new(-9553.5986328125, 65.62338256835938, 6041.58837890625).Position - game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).Magnitude <= 3 or not _G.AutoNevaSoulGuitar
                                            wait(1)
...
--                                             for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
                                                if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and getHumanoidSafe(v).Health > 0 then
                                                    if v.Name == "Living Zombie" then
                                                        ...
                                                        v:FindFirstChild("Humanoid").WalkSpeed = 0
                                                        v:FindFirstChild("Humanoid")RootPart.CanCollide = false
                                                        v:FindFirstChild("Humanoid")RootPart.CFrame = game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.CFrame * CFrame.new(0,20,0)
...
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                     wait() 
                until _G.StopTween == true or not _G.AutoObservationHakiV2 or (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position-Vector3.new(-12444.78515625, 332.40396118164, -7673.1806640625)).Magnitude <= 10
                wait(.5)
...
--                                 repeat wait()
                                    ...
                                    EquipWeapon(_G.SelectWeapon)
                                    topos(v:FindFirstChild("Humanoid")RootPart.CFrame * Pos)
                                    PosHee =  v:FindFirstChild("Humanoid")RootPart.CFrame
                                    v:FindFirstChild("Humanoid")RootPart.CFrame = v:FindFirstChild("Humanoid")RootPart.CFrame
                                    v:FindFirstChild("Humanoid")RootPart.CanCollide = false
                                    v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(50,50,50)
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                     game:GetService'VirtualUser':CaptureController()
                                ...
                                until _G.AutoObservationHakiV2 == false or v:FindFirstChild("Humanoid").Health <= 0
...
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                             wait() 
                        until _G.StopTween == true or not _G.AutoObservationHakiV2 or (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position-Vector3.new(-13277.568359375, 370.34185791016, -7821.1572265625)).Magnitude <= 10
                    end
...
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                             wait() 
                        until _G.StopTween == true or not _G.AutoObservationHakiV2 or (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position-Vector3.new(-13493.12890625, 318.89553833008, -8373.7919921875)).Magnitude <= 10
                    end        
                end
            end
...
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                     wait() 
                until _G.StopTween == true or not _G.AutoObservationHakiV2 or (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position-Vector3.new(-10920.125, 624.20275878906, -10266.995117188)).Magnitude <= 10
                wait(.5)
...
--                 for i,v in pairs(game.Workspace:GetDescendants()) do
                    if v.Name == "Apple" or v.Name == "Banana" or v.Name == "Pineapple" then
                        v.Handle.CFrame = game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.CFrame * CFrame.new(0,1,10)
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                         wait()
                        firetouchinterest(game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart,v.Handle,0)    
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                         wait()
                    end
                end   
...
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                 for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
                    if v.Name == "Forest Pirate" and v:FindFirstChild("Humanoid") and getHumanoidSafe(v).Health > 0 then
                        if v.Name == "Forest Pirate" then
                            v:FindFirstChild("Humanoid")RootPart.CanCollide = false
                            v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(50, 50, 50)
                            v:FindFirstChild("Humanoid")RootPart.CFrame = PosHee
...
--                                         Click()
                        ...
                        if (CFrame.new(-12361.7060546875, 603.3547973632812, -6550.5341796875).Position - game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).Magnitude <= 100 then
                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CDKQuest","Progress","Good")
                            wait(1)
                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CDKQuest","Progress","Evil")
                            wait(1)
...
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                             repeat wait()
                                topos(v:FindFirstChild("Humanoid")RootPart.CFrame * CFrame.new(0,0,-2))
...
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--             for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                if Auto_Quest_Yama_2 and v:FindFirstChild("HazeESP") and (getHumanoidSafe(v)RootPart.Position - PosMonsEsp.Position).magnitude <= 300 then
                    v:FindFirstChild("Humanoid")RootPart.CFrame = PosMonsEsp
                    v:FindFirstChild("Humanoid")RootPart.CanCollide = false
                    v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(50,50,50)
                    if not getHumanoidSafe(v)RootPart:FindFirstChild("BodyVelocity") then
                        local vc = Instance.new("BodyVelocity", v:FindFirstChild("Humanoid")RootPart)
...
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                 Click()
                                if getHumanoidSafe(v).Health <= 0 and getHumanoidSafe(v):FindFirstChild("Animator") then
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                     v:FindFirstChild("Humanoid").Animator:Destroy()
                                end							
                            end      
                        until Auto_Cursed_Dual_Katana == false or Auto_Quest_Yama_2 == false or not v.Parent or getHumanoidSafe(v).Health <= 0 or not v:FindFirstChild("HazeESP")
                    else
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                         for x,y in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do
                            if y:FindFirstChild("HazeESP") then
                                if (y:FindFirstChild("Humanoid")RootPart.Position - game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).Magnitude > 2000 then
                                    topos(y:FindFirstChild("Humanoid")RootPart.CFrameMon* Farm_Mode)
                                else
                                    topos(y:FindFirstChild("Humanoid")RootPart.CFrame * Farm_Mode)
                                end
                            end
                        end
                    end
...
--                                                 v:FindFirstChild("Humanoid").Animator:Destroy()
                                        ...
                                        until v:FindFirstChild("Humanoid").Health <= 0 or not v.Parent or Auto_Quest_Yama_3 == false
                                    end
                                end
                            end
                        else
...
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                     for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        if Auto_Quest_Tushita_2 and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and getHumanoidSafe(v).Health > 0 then
                            if (v:FindFirstChild("Humanoid")RootPart.Position - game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).Magnitude < 2000 then
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                 repeat wait()
                                    EquipWeapon(Sword)
...
--                                         v:FindFirstChild("Humanoid").Animator:Destroy()
                                ...
                                until v:FindFirstChild("Humanoid").Health <= 0 or not v.Parent or Auto_Quest_Tushita_2 == false
                            end
                        end
                    end
                else
...
--                                                 v:FindFirstChild("Humanoid").Animator:Destroy()
                                        ...
                                        until v:FindFirstChild("Humanoid").Health <= 0 or not v.Parent or Auto_Quest_Tushita_3 == false
                                    end
                                end
                            end
                        else
...
--                                         game:GetService("VirtualUser"):CaptureController()
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                        sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
                                    until not  _G.Autotushita or not v.Parent or v:FindFirstChild("Humanoid").Health <= 0
                                end
                            end
                        end
                    else
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position - TushitaPos.Position).Magnitude > 1500 then
                    BTP(TushitaPos)
                    elseif (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position - TushitaPos.Position).Magnitude < 1500 then
                    topos(TushitaPos)
                    end
                else
                    topos(TushitaPos)
...
--                                         game:GetService("VirtualUser"):CaptureController()
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                        sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
                                    until not  _G.AutoCarvender or not v.Parent or v:FindFirstChild("Humanoid").Health <= 0
                                end
                            end
                        end
                    else
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position - CavandisPos.Position).Magnitude > 1500 then
                    BTP(CavandisPos)
                    elseif (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position - CavandisPos.Position).Magnitude < 1500 then
                    topos(CavandisPos)
                    end
                else
                    topos(CavandisPos)
...
--                                         game:GetService("VirtualUser"):CaptureController()
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                        sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
                                    until not  _G.AutoTwinHook or not v.Parent or v:FindFirstChild("Humanoid").Health <= 0
                                end
                            end
                        end
                    else
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position - ElephantPos.Position).Magnitude > 1500 then
                    BTP(ElephantPos)
                    elseif (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position - ElephantPos.Position).Magnitude < 1500 then
                    topos(ElephantPos)
                    end
                else
                    topos(ElephantPos)
...
--                                                 game:GetService("VirtualUser"):CaptureController()
                                                game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                            until _G.Namfon == false or v:FindFirstChild("Humanoid").Health <= 0 or not v.Parent
                                            Fastattack = false
                                        end
                                    end
                                end
                            ...
                            if BypassTP then
                            if (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position - GGPos.Position).Magnitude > 1500 then
                            BTP(GGPos)
                            elseif (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position - GGPos.Position).Magnitude < 1500 then
                            topos(GGPos)
                            end
                        else
                            topos(GGPos)
...
--                                         game:GetService("VirtualUser"):CaptureController()
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                    until not _G.Auto_Bone2 or not v.Parent or v:FindFirstChild("Humanoid").Health <= 0
                                end
                            end
                        end
                    else
...
--                                     game:GetService("VirtualUser"):CaptureController()
                                    ...
                                    v:FindFirstChild("Humanoid")RootPart.Transparency = 1
                                    sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
                                until v:FindFirstChild("Humanoid").Health <= 0 or _G.AutoFarmBossHallow == false
                            end
                        end
                    elseif game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Hallow Essence") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Hallow Essence") then
                        ...
                        _G.Auto_Random_Bone2 = false
                        repeat topos(CFrame.new(-8932.322265625, 146.83154296875, 6062.55078125)) wait() until (CFrame.new(-8932.322265625, 146.83154296875, 6062.55078125).Position - game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).Magnitude <= 8                        
...
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                         for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == ("rip_indra True Form" or v.Name == "rip_indra") and getHumanoidSafe(v).Health > 0 and v:IsA("Model") and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                 repeat task.wait()
                                    pcall(function()
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
...
--                                         game:GetService("VirtualUser"):CaptureController()
                                ...
                                until _G.AutoDarkDagger == false or v:FindFirstChild("Humanoid").Health <= 0
                            end
                        end
                    else
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position - AdminPos.Position).Magnitude > 1500 then
                    BTP(AdminPos)
                    elseif (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position - AdminPos.Position).Magnitude < 1500 then
                    topos(AdminPos)
                    end
                else
                    topos(AdminPos)
...
--                             AutoHaki()
                            EquipWeapon(_G.SelectWeapon)
                            TP1(v:FindFirstChild("Humanoid")RootPart.CFrame * CFrame.new(0,300,0))
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                             game:GetService("VirtualUser"):CaptureController()
                            game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                       else
                    ...
                    if not game:GetService("Workspace").Boats:FindFirstChild("PirateBrigade") then 
                        if not game:GetService("Workspace").Boats:FindFirstChild("PirateBasic") then
                            if not game:GetService("Workspace").Boats:FindFirstChild("PirateBrigade") then
                                ...
                                if (CFrame.new(-11.78054428100586, 10.302456855773926, 2927.2255859375).Position - game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).magnitude <= 10 then
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
...
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                     repeat wait()
                                        if (game:GetService("Workspace").Boats.PirateBrigade.VehicleSeat.CFrame.Position - game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).magnitude <= 10 then
...
--                             repeat wait()
                                game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Sit = false
                                TPP(v:FindFirstChild("Humanoid")RootPart.CFrame * CFrame.new(0,500,0))
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                 EquipAllWeapon()  
                                AutoSkill = true
                                AimBotSkillPosition = v:FindFirstChild("Humanoid")RootPart
                                Skillaimbot = true
            ...
            pcall(function()
                if _G.SelectPly ~= nil then 
                    if game.Players:FindFirstChild(_G.SelectPly) then
                        if game.Players:FindFirstChild(_G.SelectPly).getHumanoidSafe(Character).Health > 0 then
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                             repeat task.wait()
                                EquipWeapon(_G.SelectWeapon)
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                 AutoHaki()
                                game.Players:FindFirstChild(_G.SelectPly).getHumanoidSafe(Character)RootPart.CanCollide = false
                                topos(game.Players:FindFirstChild(_G.SelectPly).getHumanoidSafe(Character)RootPart.CFrame * CFrame.new(0,5,0))
                                spawn(function()
                                    pcall(function()
                                        if _G.SelectWeapon == SelectWeaponGun then
                                            local args = {
                                                [1] = game.Players:FindFirstChild(_G.SelectPly).getHumanoidSafe(Character)RootPart.Position,
                                                [2] = game.Players:FindFirstChild(_G.SelectPly).getHumanoidSafe(Character)RootPart
                                            }
                                            game:GetService("Players").LocalPlayer.Character[SelectWeaponGun].RemoteFunctionShoot:InvokeServer(unpack(args))
                                        else
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                             game:GetService("VirtualUser"):CaptureController()
                            ...
                            until game.Players:FindFirstChild(_G.SelectPly).getHumanoidSafe(Character).Health <= 0 or not game.Players:FindFirstChild(_G.SelectPly) or not _G.Auto_Kill_Ply
                        else 
                            if game.Players.LocalPlayer.Character:FindFirstChild("Humanoid").Health <= 3000 then
                                topos(game.Players:FindFirstChild(_G.SelectPly).getHumanoidSafe(Character)RootPart.CFrame * CFrame.new(0,30,0))
                            end
                        end
                    end
                end
...
--             for i,v in pairs(game:GetService("Players"):GetPlayers()) do
                if v.Name ~= game:GetService("Players").LocalPlayer.Name then
                    local Distance = v:DistanceFromCharacter(game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position)
...
--     while task.wait() do
        if _G.Aimbot_Gun and game:GetService("Players").LocalPlayer.Character:FindFirstChild(SelectWeaponGun) then
            pcall(function()
                ...
                local args = {
                    [1] = game:GetService("Players"):FindFirstChild(PlayerSelectAimbot).getHumanoidSafe(Character)RootPart.Position,
                    [2] = game:GetService("Players"):FindFirstChild(PlayerSelectAimbot).getHumanoidSafe(Character)RootPart
                }
                game:GetService("Players").LocalPlayer.Character[SelectWeaponGun].RemoteFunctionShoot:InvokeServer(unpack(args))
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                 game:GetService'VirtualUser':CaptureController()
...
-- 			for i,v in pairs(game:GetService("Players"):GetPlayers()) do
				if v.Name ~= game.Players.LocalPlayer.Name then
					local Distance = v:DistanceFromCharacter(game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position)
					if Distance < MaxDistance then
						MaxDistance = Distance
	...
	pcall(function()
		game:GetService("RunService").RenderStepped:connect(function()
			if AimSkillNearest and TargetPlayerAim ~= nil and game.Players.LocalPlayer.Character:FindFirstChildOfClass("Tool") and game.Players.LocalPlayer.Character[game.Players.LocalPlayer.Character:FindFirstChildOfClass("Tool").Name]:FindFirstChild("MousePos") then
				local args = {
					[1] = game:GetService("Players"):FindFirstChild(TargetPlayerAim).getHumanoidSafe(Character)RootPart.Position
				}
					...
					elseif BlueGear and BlueGear.Transparency == 1 then
						if
							HighestPointRealCFrame and
								(game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position -
...
--                                     AutoHaki()
                                    ...
                                    v.Head.CanCollide = false 
                                    FarmMag = true
                                    PosGG = v:FindFirstChild("Humanoid")RootPart.CFrame
                                    topos(v:FindFirstChild("Humanoid")RootPart.CFrame * Pos)
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                                     game:GetService("VirtualUser"):CaptureController()
                                    game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                until not StardFarm or not v.Parent or v:FindFirstChild("Humanoid").Health <= 0
                            end
                        end
                    end
                else
                        ...
                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and getHumanoidSafe(v).Health > 0 then
                            pcall(function()
                                repeat wait(.1)
                                    ...
                                    v:FindFirstChild("Humanoid")RootPart.CanCollide = false
                                    sethiddenproperty(game.Players.LocalPlayer, "SimulationRadius", math.huge)
                                until not _G.AutoQuestRace or not v.Parent or v:FindFirstChild("Humanoid").Health <= 0
                            end)
                        end
                    end
                elseif game:GetService("Players").LocalPlayer.Data.Race.Value == "Skypiea" then
...
--                             for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
                            ...
                            game:GetService("VirtualInputManager"):SendKeyEvent(true,122,false,game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart)
                            game:GetService("VirtualInputManager"):SendKeyEvent(false,122,false,game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart)
                            wait(.2)
                            game:GetService("VirtualInputManager"):SendKeyEvent(true,120,false,game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart)
                            game:GetService("VirtualInputManager"):SendKeyEvent(false,120,false,game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart)
                            wait(.2)
                            game:GetService("VirtualInputManager"):SendKeyEvent(true,99,false,game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart)
                            game:GetService("VirtualInputManager"):SendKeyEvent(false,99,false,game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart)
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--                             for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
                                if v:IsA("Tool") then
...
if v.Name ~= game.Players.LocalPlayer.Name then
if v:WaitForChild("Humanoid").Health > 0 and (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position - v:FindFirstChild("Humanoid")RootPart.Position).Magnitude <= 100 then
plyselecthunthelpold = v:FindFirstChild("Humanoid").Health
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
-- repeat task.wait()
NameTarget = v.Name
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
...
EquipWeapon(_G.SelectWeapon)
NameTarget = v.Name
TP1(v:FindFirstChild("Humanoid")RootPart.CFrame * CFrame.new(0,0,3))
v:FindFirstChild("Humanoid")RootPart.CanCollide = false
v:FindFirstChild("Humanoid")RootPart.Size = Vector3.new(100, 100, 100)
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
-- Click()
...
if tostring(game.Players.LocalPlayer.Team) == "Pirates" then
    topos(v:FindFirstChild("Humanoid")RootPart.CFrame * CFrame.new(0,0,3))
...
spawn(function()
if (v:FindFirstChild("Humanoid")RootPart.Position - game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position).Magnitude <= 10 then
    spawn(function()
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
--         Z()
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
...
v:FindFirstChild("Humanoid")RootPart.CanCollide = false
TargetSelectHunt = v:FindFirstChild("Humanoid")
until KillPlayer == false or getHumanoidSafe(v).Health == 0 or not v:FindFirstChild("HumanoidRootPart") or not v:FindFirstChild("Humanoid") or not v.Parent or NextplySelect == true
NextplySelect = false
...
--         while wait() do
        if _G.Hopfinddao then
            if game:GetService("Workspace").Map:FindFirstChild("MysticIsland") or game:GetService("Workspace").Map:FindFirstChild("MysticIsland") then
                if HighestPointRealCFrame and (game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")RootPart.Position - HighestPointRealCFrame.Position).Magnitude > 10 then
-- [AVISO] Linha comentada para evitar erro de chamada a nil:
